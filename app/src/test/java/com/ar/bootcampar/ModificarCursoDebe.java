...
public class ModificarCursoDebe {
    ...
    public void lanzarExcepcion_cuandoSeQuiereModificarObjetoNulo() {
        ...
        Exception exception = assertThrows(RuntimeException.class, () -> sut.modificarCurso(null, TITULO_CURSO, DESCRIPCION_CURSO, ES_FAVORITO_CURSO, IMAGEN_CURSO, NIVEL_CURSO));
    ...
    public void lanzarExcepcion_cuandoSeQuiereUsarUnTituloInvalido() {
        ...
        Database sut = new TestableDatabase(new SqliteDatabaseWrapperSpy.Builder().build());
        Exception exception = assertThrows(RuntimeException.class, () -> sut.modificarCurso(curso, TITULO_CURSO_INVALIDO, DESCRIPCION_CURSO, ES_FAVORITO_CURSO, IMAGEN_CURSO, NIVEL_CURSO));
    ...
    public void lanzarExcepcion_cuandoSeQuiereUsarUnaDescripcionInvalida() {
        Curso curso = crearCursoDePrueba();
        Database sut = new TestableDatabase(new SqliteDatabaseWrapperSpy.Builder().build());
        Exception exception = assertThrows(RuntimeException.class, () -> sut.modificarCurso(curso, TITULO_CURSO, DESCRIPCION_CURSO_INVALIDA, ES_FAVORITO_CURSO, IMAGEN_CURSO, NIVEL_CURSO));
    ...
    public void lanzarExcepcion_cuandoSeQuiereUsarUnaImagenInvalida() {
        Curso curso = crearCursoDePrueba();
        Database sut = new TestableDatabase(new SqliteDatabaseWrapperSpy.Builder().build());
        Exception exception = assertThrows(RuntimeException.class, () -> sut.modificarCurso(curso, TITULO_CURSO, DESCRIPCION_CURSO, ES_FAVORITO_CURSO, IMAGEN_CURSO_INVALIDA, NIVEL_CURSO));
    ...
    public void lanzarExcepcion_cuandoSeQuiereUsarUnNivelInvalido() {
        Curso curso = crearCursoDePrueba();
        Database sut = new TestableDatabase(new SqliteDatabaseWrapperSpy.Builder().build());
        Exception exception = assertThrows(RuntimeException.class, () -> sut.modificarCurso(curso, TITULO_CURSO, DESCRIPCION_CURSO, ES_FAVORITO_CURSO, IMAGEN_CURSO, NIVEL_CURSO_INVALIDO));
    ...
    public void noSetearTransaccionComoExitosa_cuandoElTituloEsInvalido() {
        ...
        assertThrows(RuntimeException.class, () -> sut.modificarCurso(curso, TITULO_CURSO_INVALIDO, DESCRIPCION_CURSO, ES_FAVORITO_CURSO, IMAGEN_CURSO, NIVEL_CURSO));
    ...
    public void noSetearTransaccionComoExitosa_cuandoLaDescripcionEsInvalida() {
        ...
        SqliteDatabaseWrapperSpy spy = new SqliteDatabaseWrapperSpy.Builder()
                ...
                .build();
        Database sut = new TestableDatabase(spy);
        assertThrows(RuntimeException.class, () -> sut.modificarCurso(curso, TITULO_CURSO, DESCRIPCION_CURSO_INVALIDA, ES_FAVORITO_CURSO, IMAGEN_CURSO, NIVEL_CURSO));
        assertFalse(spy.getTransactionSuccessfulCalled());
    }
    ...
    public void noSetearTransaccionComoExitosa_cuandoLaImagenEsInvalida() {
        ...
        SqliteDatabaseWrapperSpy spy = new SqliteDatabaseWrapperSpy.Builder()
                ...
                .build();
        Database sut = new TestableDatabase(spy);
        assertThrows(RuntimeException.class, () -> sut.modificarCurso(curso, TITULO_CURSO, DESCRIPCION_CURSO, ES_FAVORITO_CURSO, IMAGEN_CURSO_INVALIDA, NIVEL_CURSO));
        assertFalse(spy.getTransactionSuccessfulCalled());
    }
    ...
    public void noSetearTransaccionComoExitosa_cuandoElNivelInvalido() {
        ...
        SqliteDatabaseWrapperSpy spy = new SqliteDatabaseWrapperSpy.Builder()
                ...
                .build();
        Database sut = new TestableDatabase(spy);
        assertThrows(RuntimeException.class, () -> sut.modificarCurso(curso, TITULO_CURSO, DESCRIPCION_CURSO, ES_FAVORITO_CURSO, IMAGEN_CURSO, NIVEL_CURSO_INVALIDO));
        assertFalse(spy.getTransactionSuccessfulCalled());
    }
    ...
    public void insertarDatosEnTablaCursoDePrueba() {
        ...
        SqliteDatabaseWrapperSpy spy = new SqliteDatabaseWrapperSpy.Builder()
                ...
                .build();
        Database sut = new TestableDatabase(spy);
        sut.modificarCurso(curso, TITULO_CURSO, DESCRIPCION_CURSO, ES_FAVORITO_CURSO, IMAGEN_CURSO, NIVEL_CURSO);
    ...
    public void retornarCursoModificado_cuandoSeModificaCursoEnBaseDeDatos() {
        ...
        Curso sut = database.modificarCurso(curso, TITULO_CURSO, DESCRIPCION_CURSO, ES_FAVORITO_CURSO, IMAGEN_CURSO, NIVEL_CURSO);
    ...
    public void lanzarExcepcion_cuandoUpdateRetornaError(@FromDataPoints("affected rows invalidos") int affectedRowsInvalido) {
        ...
        ISQLiteDatabaseWrapper spy = new SqliteDatabaseWrapperSpy.Builder()
                ...
                .build();
        Database database = new TestableDatabase(spy);
        Exception exception = assertThrows(RuntimeException.class, () -> database.modificarCurso(curso, TITULO_CURSO, DESCRIPCION_CURSO, ES_FAVORITO_CURSO, IMAGEN_CURSO, NIVEL_CURSO));
    ...
    public void cerrarBaseDeDatos_cuandoUpdateRetornaError() {
        ...
        Database database = new TestableDatabase(spy);
        assertThrows(RuntimeException.class, () -> database.modificarCurso(curso, TITULO_CURSO, DESCRIPCION_CURSO, ES_FAVORITO_CURSO, IMAGEN_CURSO, NIVEL_CURSO));
    ...
    public void cerrarBaseDeDatos_cuandoUpdateRetornaExito() {
        ...
        Database database = new TestableDatabase(spy);
        database.modificarCurso(curso, TITULO_CURSO, DESCRIPCION_CURSO, ES_FAVORITO_CURSO, IMAGEN_CURSO, NIVEL_CURSO);
        assertTrue(spy.getCloseCalled());
    }
}
