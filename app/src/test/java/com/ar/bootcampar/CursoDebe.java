...
public class CursoDebe {
    ...
    public void serCreado_cuandoLosDatosSonCorrectos() {
        Curso sut = new Curso(ID_CURSO, TITULO_CURSO, DESCRIPCION_CURSO, ES_FAVORITO_CURSO, IMAGEN_CURSO, NIVEL_CURSO);
    ...
    public void lanzarExcepcion_cuandoIdEsInvalido(@FromDataPoints("ids invalidos") int idInvalido) {
        Exception exception = assertThrows(RuntimeException.class, () -> new Curso(idInvalido, TITULO_CURSO, DESCRIPCION_CURSO, ES_FAVORITO_CURSO, IMAGEN_CURSO, NIVEL_CURSO));
    ...
    public void lanzarExcepcion_cuandoTituloEsInvalido(@FromDataPoints("cadenas invalidas") String tituloInvalido) {
        Exception exception = assertThrows(RuntimeException.class, () -> new Curso(ID_CURSO, tituloInvalido, DESCRIPCION_CURSO, ES_FAVORITO_CURSO, IMAGEN_CURSO, NIVEL_CURSO));
    ...
    public void lanzarExcepcion_cuandoDescripcionEsInvalida(@FromDataPoints("cadenas invalidas") String descripcionInvalida) {
        Exception exception = assertThrows(RuntimeException.class, () -> new Curso(ID_CURSO, TITULO_CURSO, descripcionInvalida, ES_FAVORITO_CURSO, IMAGEN_CURSO, NIVEL_CURSO));
        assertEquals("La descripción es inválida", exception.getMessage());
    }

    @Theory
    public void lanzarExcepcion_cuandoLinkImagenEsInvalido(@FromDataPoints("links invalidos") String linkInvalido) {
        Exception exception = assertThrows(RuntimeException.class, () -> new Curso(ID_CURSO, TITULO_CURSO, DESCRIPCION_CURSO, ES_FAVORITO_CURSO, linkInvalido, NIVEL_CURSO));
    ...
    public void lanzarExcepcion_cuandoNivelEsInvalido(@FromDataPoints("niveles invalidos") int nivelInvalido) {
        Exception exception = assertThrows(RuntimeException.class, () -> new Curso(ID_CURSO, TITULO_CURSO, DESCRIPCION_CURSO, ES_FAVORITO_CURSO, IMAGEN_CURSO, nivelInvalido));
